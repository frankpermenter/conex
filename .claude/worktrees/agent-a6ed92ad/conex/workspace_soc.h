...
struct WorkspaceSOC {
  ...
  friend void Initialize(WorkspaceSOC* o, double* data) {
    ...
    new (&o->sqrtW_1) Map(data + get_size_aligned(n), n, 1);
    ...
    o->sqrtW_0 = data + 5 * get_size_aligned(n) + 1;
  }
